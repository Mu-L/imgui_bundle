...
// This function pointer allows immapp to reset node editor IDs between sessions
// It's only needed when using immapp's runner loop
...
#ifndef IMGUI_BUNDLE_DISABLE_IMMAPP
    // Set up ID reset function for immapp's runner loop
