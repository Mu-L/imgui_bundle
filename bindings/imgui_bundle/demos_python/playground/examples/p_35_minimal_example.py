...
class AppState:
    def __init__(self):
        ...
        html_bytes = immapp.download_url_bytes("https://raw.githubusercontent.com/pthom/imgui_bundle/refs/heads/main/pyodide_projects/projects/min_pyodide_app/demo_heart.html")
        if len(html_bytes) > 0:
